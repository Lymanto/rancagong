...
export default function ModalEdit({
  ...
  const [whatsAppUrl, setWhatsAppUrl] = useState(umkm.whatsAppUrl);
  const [shopeeUrl, setShopeeUrl] = useState(umkm.shopeeUrl);
  const [tokopediaUrl, setTokopediaUrl] = useState(umkm.tokopediaUrl);
  const [grabUrl, setGrabUrl] = useState(umkm.grabFoodUrl);
  const [gojekUrl, setGojekUrl] = useState(umkm.goFoodUrl);
  const [tiktokUrl, setTiktokUrl] = useState(umkm.ttUrl);
  const [instagramUrl, setInstagramUrl] = useState(umkm.instagramUrl);
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    formData.append('tokopediaUrl', tokopediaUrl!);
    formData.append('grabUrl', grabUrl!);
    formData.append('gojekUrl', gojekUrl!);
                    ...
                    <div className="mt-6 flex flex-col gap-4 w-full">
                      ...
                      <div className="mb-6">
                        ...
                        <input
                          ...
                          id="gojekUrl"
                          className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                          placeholder="Gojek URL"
                          value={gojekUrl}
                          onChange={(e) => setGojekUrl(e.target.value)}
                        />
                      </div>
                      <div className="mb-6">
                        <label
